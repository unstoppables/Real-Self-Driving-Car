...
class TLDetector(object):
    ...
    def next_wp_cb(self, msg):
        self.next_wp = msg.data
        print('n_wp:{};'.format(self.next_wp))
            ...
            for i in range(len(self.stop_lines)):
                ...
                if stop_line_wp_index >= self.next_wp:
                    ...
                    if (distance < min_distance):
                        ...
                        light = self.lights[i]
                        min_distance = distance
        #print('n_wp:{}; l_wp:{}; stop:{}'.format(self.next_wp, light_wp, self.stop_lines))
        #print('stop:{}'.format(self.stop_lines))
